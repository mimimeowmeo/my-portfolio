...
//api/project/[id]
const MOCK_SINGLE: ProjectData = MOCK[0];
...
const page = () => {
  ...
  const pageData = MOCK.find(({ urlName }) => pathname.includes(urlName))!;
  const { bannerUrl, article } = pageData;
